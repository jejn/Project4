...
class MainPage(Handler):
	def get(self):
		...
		ABOUT_TEXT = ["About",
			   		  "This is a page with my personal notes from the Udacity Nanodegree: Introduction to Programming. The notes are divided in to the different stages of the program, which you can find above. For more information about Udacity and its courses go to",
			  		  "This course covers everything from the basics of the web and computers to Object Oriented Programming and building basic web applications. Here you'll find the basic concepts of HTML and CSS and a breif introduction to Computer Science.",
			  		  "Creating this page is part of the learning process within the course. I hope you'll find it useful."]

		self.render("start.html", ABOUT_TEXT=ABOUT_TEXT, 
								  greetings=greetings,
...
def name_validator(name):
	if all(l.isalpha() or l.isspace() for l in name):
		return True
